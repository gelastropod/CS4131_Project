...
class Graph3DPlane(graphViewModel: Graph3ViewModel, backgroundColorPoint: Point, darkTheme: Boolean) {
    ...
    private val colors = ArrayList(List(vertices.size / 3) {
        arrayListOf(
            lineColorPoint.x.toFloat(), lineColorPoint.y.toFloat(), lineColorPoint.z.toFloat(), 0.2f
        )
