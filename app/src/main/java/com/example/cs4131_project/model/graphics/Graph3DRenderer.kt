...
class Graph3DRenderer(background: Paint, graphViewModel: Graph3ViewModel, darkTheme: Boolean) : GLSurfaceView.Renderer {
    val backgroundColorPoint = Point.toPoint(background)
    private val graph = Graph3D(graphViewModel, backgroundColorPoint)
    ...
    override fun onSurfaceChanged(gl: GL10?, width: Int, height: Int) {
        ...
        Matrix.frustumM(graph.projectionMatrix, 0, -ratio, ratio, -1f, 1f, 3f, 7f)
    }
